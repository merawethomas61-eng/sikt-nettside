  ...
  const plans: Plan[] = [
    {
      ...
      features: [
        ...
        { text: "8 AI-skrevne artikler i måneden — innholdsmotor på autopilot", detail: "Fire ganger så mange som Standard: Sikt finner søkene du kan vinne, skriver komplette artikler målrettet mot dem, og legger dem som utkast i WordPress til godkjenning. Nytt målrettet innhold er den sterkeste enkeltdriveren for å rangere høyere." },
    ...
    },
    {
      ...
      features: [
        ...
        { text: "2 AI-skrevne artikler i måneden — sendt som utkast til WordPress", detail: "Den 1. hver måned lager Sikt en innholdsplan: søkeordene du nesten rangerer på, og hull konkurrentene dine dekker. Utkastene skrives automatisk (1000+ ord med SEO-tittel, meta-beskrivelse, FAQ og interne lenker) og venter på deg i portalen. Du leser gjennom, godkjenner og publiserer — ingenting går live uten deg. Etterpå ser du resultatet per artikkel: posisjonen da den ble skrevet, og posisjonen nå." },
        ...
        { text: "Ukentlig «Dette har Sikt fikset for deg»-kvittering (pushet til siden)", detail: "Hver mandag: «12 meta-titler oppdatert, 3 ødelagte lenker fikset, 2 interne lenker satt inn.» I motsetning til Basic (hvor du limer inn selv), ligger disse endringene allerede live på siden din — og alt kan angres med ett klikk." },
        { text: "AI skriver og publiserer tekster, alt-tekster og schema", detail: "Meta-titler, beskrivelser, alt-tekster og strukturert data genereres og oppdateres automatisk på siden din. Sikt fjerner også ødelagte lenker og setter inn interne lenker mellom sidene dine — alltid med din godkjenning, alltid med angre-knapp." },
    ...
    },
    {
      ...
      features: [
        ...
        { text: "Ukentlig automatisk skann av alle sidene dine", detail: "Sikt crawler siden din hver uke og finner tynt innhold, manglende meta-titler og H1-er, og ødelagte lenker — nye funn dukker opp som oppgaver i portalen av seg selv, med ferdig AI-tekst klar til innliming. I tillegg sjekkes hastighet og oppetid løpende." },
        ...
        { text: "Se henvendelsene: hvor mange ringer og skriver fra siden", detail: "Sikt teller telefon-klikk, e-post-klikk og skjema-innsendinger på nettsiden din — uten cookies og uten persondata. Så ser du det eneste tallet som faktisk betyr noe: hvor mange som tar kontakt. WordPress: aktiveres med ett klikk. Andre plattformer: lim inn en liten kodesnutt." },
