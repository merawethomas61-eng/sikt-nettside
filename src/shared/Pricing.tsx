  ...
  const plans: Plan[] = [
    ...
    },
    {
      ...
      features: [
        ...
        { text: "2 AI-skrevne artikler i måneden — sendt som utkast til WordPress", detail: "Sikt finner søkeordene du nesten rangerer på, skriver en komplett artikkel (1000+ ord med SEO-tittel, meta-beskrivelse og FAQ) basert på din bedrift, og legger den som utkast i WordPress. Du leser gjennom, godkjenner og publiserer — ingenting går live uten deg." },
